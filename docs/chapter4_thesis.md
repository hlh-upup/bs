...
为验证评估模型评分与人类主观判断的一致性，进行了主观A/B对比评估实验。实验共招募15名具备数字媒体背景的评估者，每人对100对视频样本中随机分配的20对进行盲审，在各质量维度上独立做出偏好判断，以多数投票确定各对样本的人工偏好标签。模型偏好与人工偏好的一致率（Agreement Rate）如表4-10所示。
