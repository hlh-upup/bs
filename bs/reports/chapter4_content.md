...
为深入验证模型的客观评估体系与人类主观感知之间的结构一致性，本研究分别计算了模型预测评分和人工主观评分在五个评估维度之间的相关性矩阵，并进行系统对比。表4-10a选取了与整体感知质量维度关联最密切的六对代表性维度组合（各维度与整体感知质量的关联对以及音频质量与跨模态一致性对），展示主客观评价中维度间Pearson相关系数的对比结果。
...
维度间关联性对比结果揭示了以下发现：① 模型预测与人工评分在维度间相关性模式上具有高度一致性，六对代表性维度组合的相关系数排序完全一致，表明模型成功学习到了各质量维度之间的内在关联结构；② 跨模态一致性与整体感知质量的相关性最强（客观0.624、主观0.651），反映了视听协调性在整体质量感知中的主导地位；③ 人工评分的维度间相关性普遍略高于模型预测（平均差异+0.031），这可能源于评估者在主观评价过程中的"光环效应"（halo effect）——对某一维度的正面印象倾向于影响其对其他维度的评分。模型预测不受此类认知偏差影响，各维度的预测更加独立。

上述主客观维度间关联性的高度一致性，从结构层面验证了本系统多模态多任务评估框架的合理性：模型不仅在各维度的绝对评分上与人类感知保持一致，在维度间的相对关联模式上也与人类感知高度吻合。
...
④ 主观评价实验表明，模型评分与人工主观评分在整体感知质量维度上达到了0.713的Pearson相关系数，验证了系统输出的评分结果具有良好的人类感知一致性和实际参考价值。主客观评价维度间关联性分析进一步表明，模型预测与人工评分在各维度间的关联结构上高度一致，维度对相关系数排序完全吻合，从结构层面支持了多任务联合评估框架的合理性。
