...
③ **评价维度**：参与者依据主观评价实验指标体系，对每个视频从唇音同步质量、表情自然度、音频质量、视觉清晰度和整体质量五个维度进行1.0–5.0分的连续评分（精度为0.5分）。需要说明的是，主观评价中的"视觉清晰度"维度侧重于画面分辨率、边缘清晰度和牙齿等面部细节的表现质量，与模型客观评估中的"跨模态一致性"维度存在概念差异——后者衡量音视频信号间的时序对齐与语义协调性。
...
其中，组内相关系数ICC(2,1)衡量的是单个评估者评分的可靠性，Krippendorff $\alpha$系数适用于连续变量的多评估者一致性度量。结果表明：① 整体质量维度的评估者间一致性最高（ICC=0.842），说明该维度的主观感知较为统一；② 表情自然度维度的一致性最低（ICC=0.681），评估者间标准差最大（0.65），反映出不同个体对表情自然度的感知存在较大差异，这也解释了模型在该维度上表现相对较弱的原因——人工标注本身的噪声限制了模型的学习上限；③ 唇音同步质量维度的一致性（ICC=0.798）略低于音频质量（ICC=0.823），表明评估者对唇音同步的判断标准存在一定个体差异，尤其在AI生成视频的细微同步偏差场景下。

**（3）模型评分与主观评分对比**

以11名参与者评分的均值作为人工主观评分的金标准，计算系统模型评分与该金标准之间的一致性。表4-10展示了各维度的对比结果，其中主观维度名称采用主观评价实验指标体系中的原始命名。

**表4-10 模型评分与人工主观评分的一致性对比**

| 客观维度 | 主观维度 | Pearson $r$↑ | Spearman $\rho$↑ | 平均绝对偏差↓ | 95%置信区间 |
|--------|--------|:----------:|:---------------:|:-----------:|:------------:|
| 唇形同步 | 唇音同步质量 | 0.528 | 0.493 | 0.423 | [0.421, 0.635] |
| 表情自然度 | 表情自然度 | 0.473 | 0.441 | 0.498 | [0.361, 0.585] |
| 音频质量 | 音频质量 | 0.641 | 0.608 | 0.362 | [0.548, 0.734] |
| 跨模态一致性 | 视觉清晰度 | 0.553 | 0.518 | 0.407 | [0.447, 0.659] |
| 整体感知质量 | 整体质量 | 0.706 | 0.672 | 0.328 | [0.618, 0.794] |
| **五维平均** | — | **0.580** | **0.546** | **0.404** | — |
...
主观评价实验结果表明：① 在30个视频样本上，模型评分与人工主观评分在整体质量维度上的Pearson相关系数达到0.706，与测试集上的0.698基本一致，表明多评估者均值作为金标准具有良好的稳定性；② 音频质量维度的相关系数最高（$r=0.641$），反映了HuBERT音频特征与人类语音质量感知的高度一致性；③ 跨模态一致性/视觉清晰度维度的相关系数（$r=0.553$）低于模型在测试集上的客观表现（$r=0.596$），主要原因在于两个维度的概念定义存在差异；④ 五个维度的平均绝对偏差为0.404分（满分5分），即模型评分与人工评分的平均偏差约为评分量程的8.1\%，在可接受范围内。

**（4）主客观评价维度间关联性分析**

为深入验证模型的客观评估体系与人类主观感知之间的结构一致性，本研究分别计算了模型预测评分和人工主观评分在五个评估维度之间的相关性矩阵，并进行系统对比。表4-10a选取了与整体质量维度关联最密切的四对维度组合以及两对技术维度组合，展示主客观评价中维度间Pearson相关系数的对比结果。

**表4-10a 主客观评价的维度间关联性对比（Pearson $r$）**

| 维度对 | 模型客观预测 | 人工主观评分 | 差异 |
|-------|:----------:|:----------:|:----:|
...
维度间关联性对比结果揭示了以下发现：① 模型预测与人工评分在维度间相关性的总体模式上具有较好的一致性，相关系数较高的维度对（如音频质量↔整体质量、视觉清晰度↔整体质量）在主客观评价中均排名靠前；② 六对维度组合中，三对呈现主观高于客观（差异范围+0.013至+0.023），三对呈现客观高于主观（差异范围−0.006至−0.023），差异方向不一致，反映出人类感知的复杂性以及主客观评价维度定义差异的影响；③ 涉及"视觉清晰度"的维度对（如音频质量↔视觉清晰度、视觉清晰度↔整体质量）在主观评价中的相关系数均略低于客观预测，进一步印证了该维度与模型"跨模态一致性"之间概念不对等所带来的系统性偏差。

上述分析表明，模型的客观评估体系与人类主观感知在总体结构上保持一致，但在涉及概念定义不完全对应的维度上存在系统性偏差。这一发现为未来优化主客观评价维度的对齐提供了参考依据。
...
④ 主观评价实验表明，模型评分与人工主观评分在整体质量维度上达到了0.706的Pearson相关系数，五维平均Pearson $r$为0.580，与客观测试集结果（0.581）基本一致。主客观对比分析揭示了各维度呈现互有高低的差异模式，其中视觉清晰度/跨模态一致性维度因概念定义差异而表现出最大偏差（−0.043），提示未来应优化主客观评价维度的对齐设计。
