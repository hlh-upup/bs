...
> - **4.3.5 用户主观评价实验**：
>   - （1）实验设计：被试内设计+配对比较法、12名参与者、30个分层抽样视频、5维度评分（唇音同步质量、表情自然度、音频质量、视觉清晰度、整体质量），维度映射说明
>   - （2）评估者间一致性：ICC(2,1)和Krippendorff α，整体质量ICC=0.842，表4-9
>   - （3）模型vs主观评分对比：整体质量Pearson r=0.706、五维平均r=0.580，表4-10，图4-5，图4-6
>   - （4）主客观评价维度间关联性分析：总体模式一致但局部差异方向不一（视觉清晰度/跨模态一致性概念偏差），表4-10a
>   - （5）实验结论
> - **4.3.6 跨数据集泛化性验证**：
...
> - **图表清单**：表4-1至表4-12（含表4-10a，共13张表）、图4-1至图4-7（7张图，含详细图示说明）
